...
import cn.pocketwallet.pocketwallet.ui.fragment.common.RetrievePayPasswordSMSCodeFragment;
...
public class RetrievePayPasswordActivity extends BaseActivity {
    ...
    private static final String TAG = "RetrievePayPasswordActivity";
    ...
    protected void initViews() {
        ...
        FragmentUtil.replace(getSupportFragmentManager(),
                R.id.retrievePayPasswordContainer,
                new RetrievePayPasswordSMSCodeFragment(), false,
                "RetrievePayPasswordSMSCodeFragment");
    }
    ...
    public void onBackPressed() {
        final CommonDialog commonDialog = new CommonDialog(this, R.string.sweet_note, R.string.register_auth_dialog_content, new CommonDialog.Listener() {
            ...
            public void onLeftButtonClick() {
                cn.pocketwallet.pocketwallet.ui.activity.common.RetrievePayPasswordActivity.super.onBackPressed();
            }
