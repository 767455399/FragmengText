 ...
 * 类描述：
 * 创建人：WangQing
 * 创建时间：2016/1/25 13:45
 * 修改人：WangQing
 * 修改时间：2016/1/25 13:45
 * 修改备注：
 */
public class NewNetWorkModle {
    ...
    @SerializedName("list")
    @Expose
    private java.util.List<NewNetWorkListModle> list = new ArrayList<NewNetWorkListModle>();
     ...
     * The list
     */
    public java.util.List<NewNetWorkListModle> getList() {
        return list;
    }
     ...
     * The list
     */
    public void setList(java.util.List<NewNetWorkListModle> list) {
        this.list = list;
    }
